...
<html>
    ...
    <body>
        ...
        <div class="all-lang">
            ...
            <div class="lang2">
                <a href="accueil/accueilDE.php">
                <img id="f-de" src="assets/img/flag/Unknown.png" alt="">
                </a>
                <a href="accueil/accueilFR.php">
        ...
        <!-- <footer>
                ...
                <div class="cont-btn">
                    <button class="submit"><a id="lien" href="accueil.php">✓</a></button>
                </div>
        </footer> -->
