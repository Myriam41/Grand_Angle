...
<html>
    ...
    <section class="horaires">
           <div>
               <h4>作者：Pablo Picasso</h4>
               <img class="view" src="../../assets/img/guernica-in-color.jpeg" alt="">
               <hr>
               <p>格尔尼卡》是西班牙画家巴勃罗-毕加索的一幅画，是他最著名的作品之一，也是世界上最著名的画作之一。</p>
               <hr>
               <img class="view" src="../../assets/img/Pablo_picasso_1.jpeg" alt="">
               <hr>
               <p>巴勃罗-鲁伊斯-毕加索，1881年10月25日生于马拉加，1973年4月8日死于穆根，是一位西班牙画家、绘图员、雕塑家和雕刻家，一生中大部分时间都在法国度过。。</p>
               <!-- <h4>9h → 18h</h4>
