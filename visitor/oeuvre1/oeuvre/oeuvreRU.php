...
<html>
    <head>
        ...
        <!-- TITLE -->
        <title>Grand Angle. - Работа</title>
    </head>
    ...
    <nav class="acceuil navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-item nav-link active" href="../oeuvre/oeuvreRU.php">Работа</a>
    ...
    <section class="horaires">
           <div>
               <h4>Винсент Ван Гог</h4>
               <img class="view" src="../../assets/img/van-gogh-la-nuit-etoilee-1.jpeg" alt="">
               <hr>
               <p>Звездная ночь" - картина голландского художника-постимпрессиониста Винсента Ван Гога. Картина представляет то, что Ван Гог мог видеть и экстраполировать из комнаты, которую он занимал в приюте монастыря Сен-Поль-де-Мозоль в Сен-Реми-де-Прованс в мае 1889 года.</p>
               <hr>
               <img class="view" src="../../assets/img/Self-Portrait_(Van_Gogh_September_1889).jpeg" alt="">
               <hr>
               <p>Винсент Ван Гог, родившийся 30 марта 1853 года в Гроот-Зундерте, Нидерланды, и умерший 29 июля 1890 года в Овер-сюр-Уаз, Франция, был голландским художником и рисовальщиком. Его натуралистические работы, вдохновленные импрессионизмом и пуантилизмом, стали предвестниками фовизма и экспрессионизма..</p>
               <!-- <h4>9h → 18h</h4>
