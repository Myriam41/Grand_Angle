    ...
    <nav class="acceuil navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-item nav-link" href="http://172.16.20.75/Grand_Angle/Grand_Angle/index.php?v=">Retour aux langues</a>
            </div>
        </div>
    </nav>
    <header>
            <div>
                <h2>Die sternenklare Nacht</h2>
            </div>
    </header>
    <section class="horaires">
           <div>
               <h4>Von Vincent Van Gogh</h4>
               <img class="view" src="../../assets/img/van-gogh-la-nuit-etoilee-1.jpeg" alt="">
               <hr>
               <p>Die Sternennacht ist ein Gemälde des niederländischen postimpressionistischen Malers Vincent van Gogh. Das Gemälde stellt dar, was Van Gogh im Mai 1889 von seinem Zimmer im Asyl des Klosters Saint-Paul-de-Mausole in Saint-Rémy-de-Provence aus sehen und extrapolieren konnte.</p>
               <hr>
               <img class="view" src="../../assets/img/Self-Portrait_(Van_Gogh_September_1889).jpeg" alt="">
               <hr>
               <p>Vincent van Gogh, geboren am 30. März 1853 in Groot-Zundert, Niederlande, und gestorben am 29. Juli 1890 in Auvers-sur-Oise, Frankreich, war ein niederländischer Maler und Zeichner. Sein Werk voller Naturalismus, das vom Impressionismus und Pointillismus inspiriert wurde, kündigte den Fauvismus und Expressionismus an.</p>
               <!-- <h4>9h → 18h</h4>
